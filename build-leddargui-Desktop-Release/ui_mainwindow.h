...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        settingsPageButton->setGeometry(QRect(330, 450, 181, 51));
        QPalette palette9;
        ...
        settingsPageButton->setPalette(palette9);
        QFont font3;
        ...
        streamButton->setGeometry(QRect(330, 180, 181, 61));
        QPalette palette10;
        ...
        streamButton->setPalette(palette10);
        ...
        readDataPageButton->setGeometry(QRect(330, 250, 181, 61));
        QPalette palette11;
        ...
        readDataPageButton->setPalette(palette11);
        ...
        settingsLabel->setPalette(palette12);
        QFont font4;
        ...
        notificationsButton->setPalette(palette17);
        ...
        backButtonSettings->setPalette(palette18);
        ...
        notificationsTitle->setPalette(palette19);
        ...
        notificationLabel->setPalette(palette21);
        QFont font6;
        ...
        objectTypeLabel->setPalette(palette22);
        ...
        backButton->setPalette(palette31);
        ...
        readingDataLabel->setPalette(palette32);
        QFont font7;
        ...
        readDataButton->setPalette(palette34);
        ...
        backButtonRead->setPalette(palette35);
        ...
        cancelButtonRead->setPalette(palette36);
